...
const BlockOutSchema = new mongoose_1.Schema({
    caregiverId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
...
// @ts-ignore
exports.BlockOutModel = mongoose_1.models.BlockOut || (0, mongoose_1.model)("BlockOut", BlockOutSchema);
